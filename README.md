...
---
 ### 🚀 Key Features
  ...
  - Browse all registered providers 
  - Providers can fully customize their working hours 
  - **Google Calendar integration** for reminders and notifications - Appointment booking with an interactive calendar view - Dashboard countdown showing the time left until your next appointment